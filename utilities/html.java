...
public class html {
	...
	+ "<meta id=  name= content='EEEE, MMMM dd, yyyy, hh:mm a '('zzz')''/>"
	...
	+ "<title>Test-Automaton-Report.html</title>"
...
+ "<nav>"
	+ "<div class=\"nav-wrapper\">"
		...
		+ "<span class='report-name'>Test-Automaton-Report.html</span>"
		...
		+ "<ul id='nav-mobile' class='right hide-on-med-and-down nav-right'>"
			+ "<li>"
                + "<a href='#!'>"
                    + "<span class='label suite-start-time blue darken-3'>Monday, March 09, 2020, 11:55 AM (IST)</span>"
				+ "</a>"
			+ "</li>"
			+ "<li>"
                + "<a href='#!'>"
		...
		+ "<div class='col s12 m6 l6 np-h'>"
			+ "<div class='card-panel nm-v'>"
				...
				+ "<div class='block text-small'>"
					+ "<span class='tooltipped' data-position='top' data-tooltip='100%'><span class='strong'>5</span> test(s) passed</span>"
				+ "</div>"
				+ "<div class='block text-small'>"
			...
			+ "<ul id='test-collection' class='test-collection'>"
				...
				+ "<li class='test displayed active  pass' status='pass' bdd='false' test-id='1'>"
					+ "<div class='test-heading'>"
						+ "<span class='test-name'>getCustomerDetailsAPI_VerifyResponseBodyForPrime</span>"
						+ "<span class='test-time'>Monday, March 09, 2020, 11:56 AM (IST)</span>"
						+ "<span class='test-status right pass'>pass</span>"
					+ "</div>"
					+ "<div class='test-content hide'>"
+ "<div class='test-time-info'>"
	+ "<span class='label start-time'>Monday, March 09, 2020, 11:56 AM (IST)</span>"
	+ "<span class='label end-time'>Monday, March 09, 2020, 11:56 AM (IST)</span>"
	+ "<span class='label time-taken grey lighten-1 white-text'>0h 0m 8s+51ms</span>"
+ "</div>"
		...
		+ "<table class='bordered table-results'>"
			...
			+ "<tbody>"
				+ "<tr class='log' status='pass'>"
					...
					+ "<td class='timestamp'>11:56:09 AM</td>"
					+ "<td class='step-details'><span class='label white-text green'>Test Case: to verify response of Get customer API from PRIME source system: PASSED</span></td>"
				+ "</tr>"
			+ "</tbody>"
		+ "</table>"
	+ "</div>"
				...
				+ "<li class='test displayed active  pass' status='pass' bdd='false' test-id='2'>"
					+ "<div class='test-heading'>"
						+ "<span class='test-name'>getCustomerDetailsAPI_VerifyResponseStatusCodeForPrime</span>"
						+ "<span class='test-time'>Monday, March 09, 2020, 11:56 AM (IST)</span>"
						+ "<span class='test-status right pass'>pass</span>"
					+ "</div>"
					+ "<div class='test-content hide'>"
		...
		+ "<table class='bordered table-results'>"
			...
			+ "<tbody>"
				+ "<tr class='log' status='pass'>"
					+ "<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>"
					+ "<td class='timestamp'>11:56:09 AM</td>"
					+ "<td class='step-details'><span class='label white-text green'>Test Case: to verify the reponse status code of Get Customer API for Prime source system is 200" +"or not: PASSED</span></td>"
				+ "</tr>"
			+ "</tbody>"
		+ "</table>"
	+ "</div>"
				...
				+ "<li class='test displayed active  pass' status='pass' bdd='false' test-id='3'>"
					+ "<div class='test-heading'>"
						+ "<span class='test-name'>getCustomerDetailsAPI_VerifyResponseStatusLineForPrime</span>"
						+ "<span class='test-time'>Monday, March 09, 2020, 11:56 AM (IST)</span>"
						+ "<span class='test-status right pass'>pass</span>"
					+ "</div>"
					+ "<div class='test-content hide'>"
...
+ "</div>"
		...
		+ "<table class='bordered table-results'>"
			...
			+ "<tbody>"
				+ "<tr class='log' status='pass'>"
					+ "<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>"
					+ "<td class='timestamp'>11:56:09 AM</td>"
					+ "<td class='step-details'><span class='label white-text green'>Test Case: to verify the reponse status Line of Get Customer API for Prime source system:"
					+ "PASSED</span></td>"
				+ "</tr>"
			+ "</tbody>"
		+ "</table>"
	+ "</div>"
				...
				+ "<li class='test displayed active  pass' status='pass' bdd='false' test-id='4'>"
					+ "<div class='test-heading'>"
						+ "<span class='test-name'>getCustomerDetailsAPI_checkResponseTimeForPrime</span>"
						+ "<span class='test-time'>Monday, March 09, 2020, 11:56 AM (IST)</span>"
						+ "<span class='test-status right pass'>pass</span>"
					+ "</div>"
					+ "<div class='test-content hide'>"
		...
		+ "<table class='bordered table-results'>"
			...
			+ "<tbody>"
				+ "<tr class='log' status='pass'>"
					+ "<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>"
					+ "<td class='timestamp'>11:56:09 AM</td>"
					+ "<td class='step-details'><span class='label white-text green'>Test Case: to verify the reponse time of Get Customer API for Prime source system is less than" 
					+ "4secs: PASSED</span></td>"
				+ "</tr>"
			+ "</tbody>"
		+ "</table>"
	+ "</div>"
				...
				+ "<li class='test displayed active  pass' status='pass' bdd='false' test-id='5'>"
					+ "<div class='test-heading'>"
						+ "<span class='test-name'>getCustomerDetailsAPI_VerifyContentTypeForPrime</span>"
						+ "<span class='test-time'>Monday, March 09, 2020, 11:56 AM (IST)</span>"
						+ "<span class='test-status right pass'>pass</span>"
					+ "</div>"
					+ "<div class='test-content hide'>"
+ "<div class='test-time-info'>"
	+ "<span class='label start-time'>Monday, March 09, 2020, 11:56 AM (IST)</span>"
	+ "<span class='label end-time'>Monday, March 09, 2020, 11:56 AM (IST)</span>"
	+ "<span class='label time-taken grey lighten-1 white-text'>0h 0m 0s+9ms</span>"
+ "</div>"
	+ "<div class='test-steps'>"
		+ "<table class='bordered table-results'>"
			+ "<thead>"
			...
			+ "<tbody>"
				+ "<tr class='log' status='pass'>"
					+ "<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>"
					+ "<td class='timestamp'>11:56:09 AM</td>"
					+ "<td class='step-details'><span class='label white-text green'>Test Case: to verify the content type of Get Customer API for Prime source system:\" PASSED</span></td>"
				+ "</tr>"
			+ "</tbody>"
		+ "</table>"
	+ "</div>"
